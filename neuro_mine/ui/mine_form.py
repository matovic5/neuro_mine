...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        Widget.resize(574, 619)
        self.widget = QWidget(Widget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(810, 210, 144, 532))
        self.widget1 = QWidget(Widget)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(0, 0, 573, 617))
        ...
        self.gridLayout.addWidget(self.checkBox_3, 17, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_9, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_10, 18, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_6, 20, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_26, 16, 2, 1, 1)
        ...
        self.lineEdit_8 = QLineEdit(self.widget1)
        ...
        self.gridLayout.addWidget(self.label_23, 12, 2, 1, 1)

        self.pushButton = QPushButton(self.widget1)
        self.pushButton.setObjectName(u"pushButton")

        self.gridLayout.addWidget(self.pushButton, 20, 2, 1, 1)
        ...
        self.label_28.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.label_28.setPixmap(QPixmap(u":/question.png"))

        self.gridLayout.addWidget(self.label_28, 2, 3, 1, 1)

        self.label_29 = QLabel(self.widget1)
        self.label_29.setObjectName(u"label_29")
        self.label_29.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_15.setText(QCoreApplication.translate("Widget", u"Populate with Parameters from JSON:", None))
