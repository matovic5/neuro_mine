...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QRect(11, 20, 288, 23))
        ...
        self.layoutWidget4.setGeometry(QRect(20, 550, 268, 32))
        self.horizontalLayout_16 = QHBoxLayout(self.layoutWidget4)
        self.horizontalLayout_16.setObjectName(u"horizontalLayout_16")
        self.horizontalLayout_16.setContentsMargins(0, 0, 0, 0)
        self.pushButton_5 = QPushButton(self.layoutWidget4)
        ...
        self.pushButton_6 = QPushButton(self.layoutWidget4)
        ...
        self.layoutWidget8.setGeometry(QRect(14, 12, 571, 35))
        self.horizontalLayout_12 = QHBoxLayout(self.layoutWidget8)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.label_2 = QLabel(self.layoutWidget8)
        ...
        self.pushButton_7 = QPushButton(self.layoutWidget8)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("Form", u"Generate Diagnostics (Increase Runtime)", None))
